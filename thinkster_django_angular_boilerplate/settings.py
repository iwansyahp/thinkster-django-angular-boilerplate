...
DEBUG = os.environ.get('DEBUG', True) # secara default == True
...
# User(model) yang akan digunakan untuk auth
# defaultnya adalah User, ketika dibuat superuser
# diganti menjadi model Account yang telah kita buat.
